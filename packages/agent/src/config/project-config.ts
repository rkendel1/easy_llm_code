...
export const resetProjectConfig = async (projectId: string): Promise<ProjectConfig> => { await writeProjectConfig(projectId, DEFAULT_PROJECT_CONFIG); return DEFAULT_PROJECT_CONFIG; };
